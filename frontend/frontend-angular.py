...
src_directory = '../../lachesis/intelligent_nursing/src/MNIS/modules/configuration/deptClinicalKnowledgeBase'
output_file_path = './frontend/angular-doc.txt'   
project_name = 'angular-doc'
extensions_to_read = ['.js', '.html', '.tsx'] 
